...
class Expense(Base):
    ...
    category: Mapped[str] = mapped_column(sa.String(30), nullable=False)  # rent/utility/labor/fee/other
...
class Invoice(Base):
    ...
    invoice_type: Mapped[str] = mapped_column(sa.String(20), default="electronic")  # electronic/paper
    ...
    __table_args__ = (sa.UniqueConstraint("merchant_id", "invoice_number", name="uq_invoice_per_merchant"),)
